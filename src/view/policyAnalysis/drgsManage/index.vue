  ...
  <div>
    <kindo-card-search>
      ...
      <el-form :model="searchForm" inline label-width="100px" slot="more">
        <el-form-item label="单病种名称：">
          <el-input v-model="searchForm.dbzmc" style="width:140px"></el-input>
        </el-form-item>
      </el-form>
    </kindo-card-search>
    ...
    <kindo-card>
      <el-row :gutter="20">
        ...
        <el-col :span="12">
          <div style="text-align: center;margin-top:8px;">
            <span class="exportTitle">单病种费用排序TOP</span>
            <span class="exportSpan">
    ...
    <kindo-card>
      <kindo-table ref="table" :url="api.queryDbzList" :queryParam="searchForm">
        <el-table-column width="160" label="科室名称" prop="ksmc" align="left" header-align="center" show-overflow-tooltip></el-table-column>
        <el-table-column width="160" label="单病种名称" prop="dbzmc" align="left" header-align="center" show-overflow-tooltip></el-table-column>
        ...
        <el-table-column min-width="100" label="出院人数" prop="cyrs" align="right" header-align="center" show-overflow-tooltip></el-table-column>
        <el-table-column min-width="120" label="总费用" prop="zfy" align="right" header-align="center" show-overflow-tooltip :formatter="kindo.util.formatNum"></el-table-column>
        <el-table-column width="120" label="限价标准" prop="xjbz" align="right" header-align="center" show-overflow-tooltip :formatter="kindo.util.formatNum"></el-table-column>
        <el-table-column width="120" label="超出金额比例(%)" prop="ccjebl" align="right" header-align="center" show-overflow-tooltip :formatter="kindo.util.formatNum"></el-table-column>
    ...
    <el-dialog :title="dialogTitle" :visible.sync="dialogVisible" width="80%">
      ...
      <kindo-table ref="dialogTable" :url="api.queryDbzDetail" :queryParam="Object.assign({},searchForm,dialogSearchForm,{dept_id:currentRow.ksdm,dbzbm:currentRow.dbzdm,yblxdm:currentRow.yblxdm})">
        ...
        <el-table-column width="100" label="年龄" prop="nl" align="right" header-align="center" show-overflow-tooltip></el-table-column>
        <el-table-column min-width="160" label="参保类型" prop="yblx" align="left" header-align="center" show-overflow-tooltip></el-table-column>
        <el-table-column min-width="160" label="出院主要诊断名称" prop="zyzdmc" align="left" header-align="center" show-overflow-tooltip></el-table-column>
        <el-table-column width="160" label="出院次要诊断名称" prop="cyzdmc" align="left" header-align="center" show-overflow-tooltip></el-table-column>
        <el-table-column width="120" label="住院天数" prop="zyts" align="right" header-align="center" show-overflow-tooltip></el-table-column>
        <el-table-column width="120" label="医嘱项目名称" prop="yzxmmc" align="left" header-align="center" show-overflow-tooltip></el-table-column>
        <el-table-column width="100" label="数量" prop="sl" align="right" header-align="center" show-overflow-tooltip></el-table-column>
        <el-table-column width="100" label="单价" prop="dj" align="right" header-align="center" show-overflow-tooltip :formatter="kindo.util.formatNum"></el-table-column>
        <el-table-column width="120" label="总金额" prop="zje" align="right" header-align="center" show-overflow-tooltip :formatter="kindo.util.formatNum"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    getDbzfyChart() {
      this.$http.get(config.api.getDbzfyChart, { params: Object.assign({}, this.searchForm, { topNum: this.drgsTopNum }) }).then(res => {
        ...
        if (res.data && res.data.length > 0) {
          res.data.forEach(o => {
            dateArr.push(o.dbzmc)
            valArr1.push({ name: o.dbzmc, value: o.je })
            valArr2.push({ name: o.dbzmc, value: o.rc })
          })
        }
    ...
    dialogExport() {
      kindo.util.downloadFile(
        ...
        Object.assign({}, this.searchForm, this.dialogSearchForm, {
          ...
          dbzbm: this.currentRow.dbzdm,
          yblxdm: this.currentRow.yblxdm
        })
      )
    },
    show(row) {
      this.currentRow = row
      this.dialogTitle = row.ksmc + '—' + row.dbzmc
  ...
  data() {
    return {
      ...
      topCards: {
        单病种住院人次: { title: '单病种住院人次', content: '-', contentUnit: '', standard: '-', standardUnit: '' },
        单病种住院人数: { title: '单病种住院人数', content: '-', contentUnit: '', standard: '-', standardUnit: '' },
        单病种住院总费用: { title: '单病种住院总费用（万）', content: '-', contentUnit: '', standard: '-', standardUnit: '' },
        单病种医保费用: { title: '单病种医保费用（万元）', content: '-', contentUnit: '', standard: '-', standardUnit: '' }
      },
      source: {
        deptList: [],
